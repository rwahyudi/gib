...
func TestParseVLANRef(t *testing.T) {
	tests := []struct {
		...
		{"vlan/ZG5z...:VMC%20Prd/VLAN_10/10", "10", "VLAN_10", "VMC Prd", true},
		{"vlan/ZG5z...:VMC%20Prd%20/VLAN_10/10", "10", "VLAN_10", "VMC Prd", true},
		{"vlan/ZG5z...:Data%20Center/Server%20Farm/20", "20", "Server Farm", "Data Center", true},
		{"123", "", "", "", false},
		{"", "", "", "", false},
